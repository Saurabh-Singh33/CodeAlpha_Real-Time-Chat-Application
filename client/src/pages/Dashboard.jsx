  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F8FAFC' }}>
      <header className="app-header" style={{ background: '#FFFFFF', borderBottom: '1px solid #E5E7EB' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', cursor: 'pointer' }} onClick={() => setShowProfile(true)}>
            ...
            <span style={{ fontWeight: '600', color: '#1F2937' }}>{currentUser?.name || currentUser?.username}</span>
          </div>
      ...
      <div className="dashboard-hero" style={{ position: 'relative' }}>
        ...
        <h1 className="dashboard-title" style={{ fontFamily: '"Inter", "Roboto", sans-serif', fontWeight: '800', letterSpacing: '-0.02em', zIndex: 1, position: 'relative', color: '#1F2937' }}>Premium Video Meetings for Everyone</h1>
        ...
        <div className="glass-panel" style={{ 
          ...
          <form onSubmit={handleJoin} style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', background: '#F3F4F6', border: '1px solid #E5E7EB', borderRadius: '24px', overflow: 'hidden', padding: '4px' }}>
              ...
              <button 
                ...
                onMouseOver={e => !isJoining && (e.currentTarget.style.background = '#E5E7EB')} 
        ...
        <div style={{ width: '100%', maxWidth: '850px', marginTop: '4rem', zIndex: 1, position: 'relative' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', padding: '0 0.5rem' }}>
            ...
            <span style={{ color: '#4f46e5', fontSize: '0.9rem', cursor: 'pointer', fontWeight: '600' }}>View All</span>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
            
            <div className="glass-panel" style={{ padding: '1.5rem', textAlign: 'left', borderTop: '4px solid #6366f1', position: 'relative', overflow: 'hidden', background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', borderRadius: '16px' }}>
              <div style={{ position: 'absolute', top: 0, right: 0, padding: '1rem' }}>
                <span style={{ background: 'rgba(99, 102, 241, 0.1)', color: '#4f46e5', padding: '4px 10px', borderRadius: '12px', fontSize: '0.75rem', fontWeight: '700' }}>TODAY</span>
              </div>
              <div style={{ fontSize: '0.8rem', color: '#6B7280', marginBottom: '0.5rem', fontWeight: '600', letterSpacing: '0.5px' }}>2:00 PM - 3:00 PM</div>
              <h3 style={{ fontSize: '1.15rem', marginBottom: '0.25rem', color: '#1F2937', fontWeight: '700' }}>Weekly Team Sync</h3>
              <p style={{ color: '#4B5563', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Product & Engineering</p>
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                <button className="btn btn-primary" style={{ flex: 1, padding: '0.6rem 1rem', fontSize: '0.9rem', background: '#4f46e5', color: '#FFFFFF', border: 'none', borderRadius: '8px' }}>Join Now</button>
                <button className="btn btn-secondary" style={{ padding: '0.6rem 1rem', fontSize: '0.9rem', background: 'transparent', border: '1px solid #D1D5DB', color: '#1F2937', borderRadius: '8px' }}>Details</button>
              </div>
            </div>

            <div className="glass-panel" style={{ padding: '1.5rem', textAlign: 'left', borderTop: '4px solid #10b981', position: 'relative', overflow: 'hidden', background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', borderRadius: '16px' }}>
              <div style={{ position: 'absolute', top: 0, right: 0, padding: '1rem' }}>
                <span style={{ background: 'rgba(16, 185, 129, 0.1)', color: '#059669', padding: '4px 10px', borderRadius: '12px', fontSize: '0.75rem', fontWeight: '700' }}>TOMORROW</span>
              </div>
              <div style={{ fontSize: '0.8rem', color: '#6B7280', marginBottom: '0.5rem', fontWeight: '600', letterSpacing: '0.5px' }}>10:30 AM - 11:30 AM</div>
              <h3 style={{ fontSize: '1.15rem', marginBottom: '0.25rem', color: '#1F2937', fontWeight: '700' }}>Design Review</h3>
              <p style={{ color: '#4B5563', fontSize: '0.9rem', marginBottom: '1.5rem' }}>UI/UX Team</p>
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                <button className="btn btn-secondary" style={{ flex: 1, padding: '0.6rem 1rem', fontSize: '0.9rem', background: 'transparent', border: '1px solid #D1D5DB', color: '#1F2937', borderRadius: '8px' }}>Details</button>
              </div>
            </div>

            <div className="glass-panel" style={{ padding: '1.5rem', textAlign: 'left', borderTop: '4px solid #8b5cf6', position: 'relative', overflow: 'hidden', background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', borderRadius: '16px' }}>
              <div style={{ position: 'absolute', top: 0, right: 0, padding: '1rem' }}>
                <span style={{ background: 'rgba(139, 92, 246, 0.1)', color: '#7c3aed', padding: '4px 10px', borderRadius: '12px', fontSize: '0.75rem', fontWeight: '700' }}>WEDNESDAY</span>
              </div>
              <div style={{ fontSize: '0.8rem', color: '#6B7280', marginBottom: '0.5rem', fontWeight: '600', letterSpacing: '0.5px' }}>1:00 PM - 2:00 PM</div>
              <h3 style={{ fontSize: '1.15rem', marginBottom: '0.25rem', color: '#1F2937', fontWeight: '700' }}>Client Presentation</h3>
              <p style={{ color: '#4B5563', fontSize: '0.9rem', marginBottom: '1.5rem' }}>External Partners</p>
              <div style={{ display: 'flex', gap: '0.75rem' }}>
                <button className="btn btn-secondary" style={{ flex: 1, padding: '0.6rem 1rem', fontSize: '0.9rem', background: 'transparent', border: '1px solid #D1D5DB', color: '#1F2937', borderRadius: '8px' }}>Details</button>
              </div>
            </div>
